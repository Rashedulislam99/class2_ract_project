// src/Pages/Suppliers/CreateSupplier.jsx
...
const CreateSupplier = () => {
  ...
  const handleSubmit = async () => {
    try {
      const res = await axios.post(`${baseUrl}/supplier/save`, { supplier: formData });
  ...
  style={{
    background: "linear-gradient(135deg, #7b8675ff, #d397b4ff)", // gradient background
