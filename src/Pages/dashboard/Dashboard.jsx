...
const Dashboard = () => {
  ...
  const pusrchaseReport = async () => {
    try {
      const res = await axios.get(`${baseUrl}/purchase/total_purchases/`);
      // console.log("API response:", res.data);
    
      setreport((pre) => ({
        ...pre,
        purchase:res.data.total_purchases.total,
        order:res.data.total_order.total,
      }));
    } catch (err) {
      console.log(err);
  ...
  const customersreport = async () => {
    try {
      const res = await axios.get(`${baseUrl}/customer/customers_report/`);
      console.log("API response:", res.data);
      setreport((pre) => ({
        ...pre,
        customer: res.data.customers.total_customers
      }));
    } catch (err) {
      console.log(err);
  ...
  // setreport.total_order.total
  // setreport.total_purchases.total
  //setreport.total_customers.total
  ...
  console.log("jdfdsfjksdf",report);
                    ...
                    <form action="javascript:void(0);">
                      <div className="row g-3 mb-0 align-items-center">
                        ...
                        <div className="col-auto">
                          <button type="button" className="btn btn-soft-success shadow-none"><i className="ri-add-circle-line align-middle me-1" /> Add Product</button>
                        </div>
                        {/*end col*/}
                        <div className="col-auto">
                          <button type="button" className="btn btn-soft-info btn-icon waves-effect waves-light layout-rightside-btn shadow-none"><i className="ri-pulse-line" /></button>
                        </div>
                        {/*end col*/}
                      </div>
                      {/*end row*/}
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      <div className="flex-grow-1 overflow-hidden">
                        <p className="text-uppercase fw-medium text-muted text-truncate mb-0"> Total Purchase</p>
                      </div>
                    ...
                    <div className="d-flex align-items-end justify-content-between mt-4">
                      <div>
                        <h4 className="fs-22 fw-semibold ff-secondary mb-4">$<span className="counter-value" data-target="559.25">{report.purchase && report.purchase}</span>k </h4>
              ...
              <div className="col-xl-3 col-md-6">
                ...
                <div className="card card-animate">
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-end justify-content-between mt-4">
                      <div>
                        <h4 className="fs-22 fw-semibold ff-secondary mb-4">$<span className="counter-value" data-target={36894}>{report.order && report.order}</span></h4>
              ...
              <div className="col-xl-3 col-md-6">
                ...
                <div className="card card-animate">
                  <div className="card-body">
                    ...
                    <div className="d-flex align-items-end justify-content-between mt-4">
                      <div>
                        <h4 className="fs-22 fw-semibold ff-secondary mb-4"><span className="counter-value" data-target="183.35">{report.customer && report.customer }</span>k </h4>
              ...
              <div className="col-xl-8">
                <div className="card">
                    ...
                    <div className="row g-0 text-center">
                      ...
                      <div className="col-6 col-sm-3">
                        <div className="p-3 border border-dashed border-start-0 border-end-0">
                          <h5 className="mb-1 text-success"><span className="counter-value" data-target="18.92">0</span>%
                          </h5>
                  ...
                  <div className="card-body p-0 pb-2">
                    <div className="w-100">
                      <div id="customer_impression_charts" data-colors="[&quot;--vz-success&quot;, &quot;--vz-primary&quot;, &quot;--vz-danger&quot;]" className="apex-charts" dir="ltr">
                      </div>
                    </div>
                  </div>{/* end card body */}
                </div>{/* end card */}
                ...
                <div className="card card-height-100">
                  ...
                  <div className="card-body">
                    ...
                    <div className="px-2 py-2 mt-1">
                      ...
                      <div className="progress bg-primary-subtle mt-2" style={{ height: 6 }}>
                      ...
                      <table className="table table-hover table-centered align-middle table-nowrap mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <h5 className="fs-14 my-1 fw-normal"><span className="badge bg-danger-subtle text-danger">Out
                                of stock</span> </h5>
                              <span className="text-muted">Stock</span>
                            </td>
                            <td>
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div>
                                  <h5 className="fs-14 my-1 fw-medium">
                                    <a href="apps-ecommerce-seller-details.html" className="text-reset">iTest
                                      Factory</a>
                                  </h5>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 me-2">
                                  <img src="assets/images/users/avatar-1.jpg" alt className="avatar-xs rounded-circle shadow" />
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 me-2">
                                  <img src="assets/images/users/avatar-2.jpg" alt className="avatar-xs rounded-circle shadow" />
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 me-2">
                                  <img src="assets/images/users/avatar-3.jpg" alt className="avatar-xs rounded-circle shadow" />
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 me-2">
                                  <img src="assets/images/users/avatar-4.jpg" alt className="avatar-xs rounded-circle shadow" />
                                </div>
                          ...
                          <tr>
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 me-2">
                                  <img src="assets/images/users/avatar-6.jpg" alt className="avatar-xs rounded-circle shadow" />
                                </div>
              ...
              <div className="card-body p-0">
                ...
                <div data-simplebar style={{ maxHeight: 410 }} className="p-3 pt-0">
                  <div className="acitivity-timeline acitivity-main">
                    ...
                    <div className="acitivity-item py-3 d-flex">
                      <div className="flex-shrink-0">
                        <img src="assets/images/users/avatar-2.jpg" alt className="avatar-xs rounded-circle acitivity-avatar shadow" />
                      </div>
                      <div className="flex-grow-1 ms-3">
                    ...
                    <div className="acitivity-item py-3 d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted mb-2">Offer is valid on orders of Rs.500 Or above for selected products
                          only.</p>
                    ...
                    <div className="acitivity-item py-3 d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        <h6 className="mb-1 lh-base">Flash sale starting <span className="text-primary">Tomorrow.</span>
                        </h6>
                    ...
                    <div className="acitivity-item py-3 d-flex">
                      ...
                      <div className="flex-grow-1 ms-3">
                        ...
                        <p className="text-muted mb-2"><span className="text-danger">2 days left</span> notification to
                          submit the monthly sales report. <a href="javascript:void(0);" className="link-warning text-decoration-underline">Reports Builder</a></p>
                        <small className="mb-0 text-muted">15 Oct</small>
                      </div>
                    </div>
                    <div className="acitivity-item d-flex">
                      <div className="flex-shrink-0">
                        <img src="assets/images/users/avatar-3.jpg" alt className="avatar-xs rounded-circle acitivity-avatar shadow" />
                      </div>
                      <div className="flex-grow-1 ms-3">
                        <h6 className="mb-1 lh-base">Frank Hook Commented</h6>
                        <p className="text-muted mb-2 fst-italic">" A product that has reviews is more likable to be
                          sold than a product. "</p>
                ...
                <div className="p-3 mt-2">
                  ...
                  <div className="mt-3 text-center">
                    <a href="javascript:void(0);" className="text-muted text-decoration-underline">View all
                      Categories</a>
                  </div>
                </div>
                <div className="p-3">
                        ...
                        <div className="card border border-dashed shadow-none">
                          <div className="card-body">
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <div>
                                  <p className="text-muted mb-1 fst-italic text-truncate-two-lines"> " Great product and
                                    looks great, lots of features. "</p>
                      ...
                      <div className="swiper-slide">
                        <div className="card border border-dashed shadow-none">
                          <div className="card-body">
                            <div className="d-flex">
                              <div className="flex-shrink-0">
                                <img src="assets/images/users/avatar-3.jpg" alt className="avatar-sm rounded shadow" />
                              </div>
                              <div className="flex-grow-1 ms-3">
                                <div>
                                  <p className="text-muted mb-1 fst-italic text-truncate-two-lines"> " Amazing template,
                                    very easy to understand and manipulate. "</p>
                                  <div className="fs-11 align-middle text-warning">
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                        ...
                        <div className="card border border-dashed shadow-none">
                          <div className="card-body">
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1 ms-3">
                                <div>
                                  <p className="text-muted mb-1 fst-italic text-truncate-two-lines"> "Very beautiful
                                    product and Very helpful customer service."</p>
                                  <div className="fs-11 align-middle text-warning">
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                      ...
                      <div className="swiper-slide">
                        <div className="card border border-dashed shadow-none">
                          <div className="card-body">
                            <div className="d-flex">
                              <div className="flex-shrink-0">
                                <img src="assets/images/users/avatar-2.jpg" alt className="avatar-sm rounded shadow" />
                              </div>
                              <div className="flex-grow-1 ms-3">
                                <div>
                                  <p className="text-muted mb-1 fst-italic text-truncate-two-lines">" The product is
                                    very beautiful. I like it. "</p>
                                  <div className="fs-11 align-middle text-warning">
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                                    <i className="ri-star-fill" />
                ...
                <div className="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                  <div className="card-body">
                    ...
                    <div className="mt-4">
                      ...
                      <button type="button" className="btn btn-primary btn-label rounded-pill"><i className="ri-mail-fill label-icon align-middle rounded-pill fs-16 me-2" /> Invite
                        Now</button>
                    </div>
                  </div>
                </div>
